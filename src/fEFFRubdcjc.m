function [ FRubdcj_c ] = fEFFRubdcjc( nElem, le, uj, upj, repositorio )
...
fFy = repositorio.fFyRubdc;
fFz = repositorio.fFzRubdc;
fT2 = repositorio.fT2dcRub;
...
FRubdcj_c = Fv*(ad_N1(nElem)*Nv(1,le).' + ad_N1M1(nElem)*Nv(0,le).') +...
