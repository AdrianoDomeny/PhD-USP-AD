...
TetapX1enc = enc1*FATORenc^-1; %rad/s
TetapXNM1enc = enc2*FATORenc^-1; %rad/s
...
A2 = pi*Dr2^2/4; %m^2
M2b = rho*A2*L2b; %Massa do rotor 2
M3 = argumentos.M3_pl;
g = argumentos.g;
G = E/(2*(1 + nu));
Jp = pi*d^4/32; %m^4
...
switch otimizacao
    case 1
        ...
        fTetaX1 = @(t)(0*double(t<=T0) +...
            0*double((T0<t)&&(t<=T1)) +...
            0*double((T1<t)&&(t<=T2)) +...
            alfaTeta*(t^2/2)*double((T2<t)&&(t<=T3)) +...
            (alfaTeta*(T3^2/2) + wMax*(t - T3))*double(T3<t));
        
        fTetapX1 = @(t)(0*double(t<=T0) +...
            0*double((T0<t)&&(t<=T1)) +...
            0*double((T1<t)&&(t<=T2)) +...
            alfaTeta*t*double((T2<t)&&(t<=T3)) +...
            wMax*double(T3<t));
        
        fTetappX1 = @(t)(0*double(t<=T0) +...
            0*double((T0<t)&&(t<=T1)) +...
            0*double((T1<t)&&(t<=T2)) +...
            alfaTeta*double((T2<t)&&(t<=T3)) +...
            0*double(T3<t));
